...
namespace FlappyMonkey
{
	...
	public class Game1 : Game
	{
		...
		private void youBetMeInitialize ()
		{
			...
			// Initialization 
			Youbetme.DataObjects.Content.Init("http://dev.youbetme.com/cdn");
			...
			SuperProxy.Init("https://dev.youbetme.com/svc/service.asmx", "joe@joebooth.com", "YBMSuperSecretPassword");
